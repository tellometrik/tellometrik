...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['render/ffmpeg-stream/Decoder.js', 'render/ffmpeg-stream/YUVCanvas.js'], factory)
  } else if (typeof exports === 'object') {
    // Node. Does not work with strict CommonJS, but
    // only CommonJS-like environments that support module.exports,
    // like Node.
    module.exports = factory(require('render/ffmpeg-stream/Decoder'), require('render/ffmpeg-stream/YUVCanvas'))
  } else {
  ...
  var Player = function (parOptions) {
    ...
    this._config.workerFile = this._config.workerFile || 'render/ffmpeg-stream/ffmpeg-stream/Decoder.js'
    ...
    if (this._config.useWorker) {
      ...
      worker.postMessage({ type: 'Broadway.js - Worker init',
        options: {
          rgb: !webgl,
